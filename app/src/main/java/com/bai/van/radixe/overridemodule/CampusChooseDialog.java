...
public class CampusChooseDialog extends Dialog implements View.OnClickListener {
    ...
    private String[] campusName = {"校本部", "呈贡校区"};

    public CampusChooseDialog(Context context, int theme, TimeTableRemindIntervalDialog.MyDialogListener listener) {
        super(context, theme);
